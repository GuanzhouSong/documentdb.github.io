...
1. Open setup using any of these:
   ...
   - Paste \`vscode://ms-azuretools.vscode-documentdb/local\` into your browser address bar and confirm both prompts. This needs extension version 0.10.1 or later.
